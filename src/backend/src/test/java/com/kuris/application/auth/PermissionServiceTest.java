...
class PermissionServiceTest {
  ...
  @Mock private com.kuris.domain.auth.PermissionRepository permissionRepository;
  @Mock private com.kuris.application.auth.PermissionCachePort permissionCachePort;
  @Mock private com.kuris.domain.auth.UserTenantRepository userTenantRepository;
